...
// +----------------------------------------------------------------------
namespace Application\Component\Units\VerifyImage;
...
class VerifyImage {
    ...
    public function check($code, $id = '') {
        ...
        // session 过期
        if($this->_time - $secode['verify_time'] > $this->expire) {
            $_SESSION[$key]= null;
            return false;
        }
        //file_put_contents("/home/www/wan.265g.com/cache/yzm.txt",$this->authcode(strtoupper($code)));
    ...
    public function entry($id = '') {
        ...
        $secode['verify_time'] = $this->_time;  // 验证码创建时间
        $_SESSION[$key.$id]=$secode;
        //file_put_contents("/home/www/wan.265g.com/cache/yzm1.txt",$secode['verify_code']);
