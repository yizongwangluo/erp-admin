...
namespace Application\Component\Concrete\FirstRecharge;
...
class ChannelFactory implements Factory
{
     ...
     * 获取实例
     * @param string $type
     * @return \Application\Component\Contract\FirstRecharge\Channel
     */
    public static function get_instance($type)
    {
        static $obj_cache=[];
        if(empty($obj_cache[$type])){
            $class_name="Application\\Component\\Concrete\\FirstRecharge\\Channel\\_".$type;
