...
<div class="layui-tab admin-layui-tab layui-tab-brief">
    <ul class="layui-tab-title">
        <li><a href="<?=base_url('admin/goods_category/index')?>">类别列表</a></li>
        <li  class="layui-this">新增类别</li>
    </ul>
<form action="<?php echo base_url ( 'admin/goods_category/save' ) ?>" method="post" class="layui-form">
        ...
        $.post(form.attr('action'), form.serializeArray(), function (response) {
            if (!response.status) {
                ...
                layer.msg('保存成功', {time: 2000, icon: 6}, function () {
                    window.location.href = '<?php echo site_url ( 'admin/goods_category/index' ); ?>';
                })
            }
        }, 'json');
    }
