...
<!--                            <td>ID</td>-->
                    ...
                    <a href='<?=$info['company_id']?>?title=status&sort=desc&search=<?php echo $this->input->get ( 'search' ); ?>'><i class="layui-edge layui-table-sort-desc"></i></a>
                            ...
                            <td>所属人
                                <span class="layui-table-sort layui-inline">
                    <a href='<?=$info['company_id']?>?title=real_name&sort=asc&search=<?php echo $this->input->get ( 'search' ); ?>'><i class="layui-edge layui-table-sort-asc"></i></a>
                    <a href='<?=$info['company_id']?>?title=real_name&sort=desc&search=<?php echo $this->input->get ( 'search' ); ?>'><i class="layui-edge layui-table-sort-desc"></i></a>
                </span>
                            </td>
                            <td>备注</td>
<!--                            <td>操作</td>-->
