                            ...
                            <tr>
                                ...
                                <?php if($v['review_status'] == 2){ ?>
                                    <td>
                                        ...
                                        <button class="layui-btn-xs layui-btn" type="button"  data-modal="<?php echo base_url ( 'admin/datareview/edit/'.$v['id'].'?url=reviewed' ) ?>"  data-title="审核广告费用" data-width="450px">修改</button>
                                    </td>
                                <?php }else{ ?>
                                    <td>
                                        <a class="layui-btn-xs layui-btn layui-btn-danger" type="button"  href="<?php echo base_url ( 'admin/operate/detail/'.$v['id'] ) ?>">详情</a>
                                        <button class="layui-btn-xs layui-btn layui-btn-normal" type="button"  data-modal="<?php echo base_url ( 'admin/datareview/edit/'.$v['id'].'?url=reviewed' ) ?>"  data-title="审核广告费用" data-width="450px">审核</button>
                                    </td>
                                <?php } ?>
                            </tr>
                        <?php endforeach;?>
