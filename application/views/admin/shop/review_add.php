<form class="layui-form layui-modal" action="<?php echo base_url ( 'admin/shop/review_add' ) ?>" method="post">
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            <button type="button" class="layui-btn" data-url="<?php echo base_url ( 'admin/shop/'.$url ) ?>" lay-submit lay-filter="post">保存</button>
            <a href='<?php echo base_url ( 'admin/shop/'.$url ) ?>'><button type="button" class="layui-btn ">取消</button></a>
        </div>
    </div>
</form>
