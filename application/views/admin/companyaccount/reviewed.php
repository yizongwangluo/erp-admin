                        ...
                        <?php foreach ($data as $v): ?>
                            <tr>
                                ...
                                <?php if($v['apply_status'] == 0){ ?>
                                    <td><button class="layui-btn-xs layui-btn layui-btn-normal" type="button"  data-modal="<?php echo base_url ( 'admin/companyaccount/review_edit/'.$v['id'].'?url=reviewed' ) ?>"  data-title="账号审批" data-width="450px">审批</button></td>
                                <?php }else{ ?>
